...
export const skillGroups: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: 'Java / Grails', weight: 2, where: { en: 'FitBank — the J.P. Morgan receivables system; Vigil — a Kafka Streams topology', pt: 'FitBank — sistema de recebíveis do J.P. Morgan; Vigil — uma topologia Kafka Streams' } },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Kafka', weight: 3, where: { en: 'FitBank — async communication between services; Vigil — windowed stream processing and a compacted changelog', pt: 'FitBank — comunicação assíncrona entre serviços; Vigil — processamento em janelas e changelog compactado' } },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'AWS', weight: 3, where: { en: 'FitBank and Zetti — EKS and RDS; Vigil — Lambda, DynamoDB, IAM', pt: 'FitBank e Zetti — EKS e RDS; Vigil — Lambda, DynamoDB, IAM' } },
      ...
      { name: 'Terraform', weight: 2, where: { en: 'Vigil — Lambda, DynamoDB, IAM and budget guards as code', pt: 'Vigil — Lambda, DynamoDB, IAM e limites de custo como código' } },
